...
If by any chance you feel stuck - here are project files for this tutorial part [here](If you wish to skip the boring boilerplate setup from previous tutorial you can download the template [here](https://github.com/TheoXD/tinysol/archive/6ecf74c8afef3e4bf90a81a312d91bdda923995f.zip).
